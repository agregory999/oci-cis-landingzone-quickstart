...
locals {
  ...
  workload_compartments = { for cmp in [var.workload_name] : "${local.workload_compartment_name_prefix}-${cmp}-${local.workload_compartment_name_suffix}" => {
    ...
    workload_group_name : "${local.workload_group_prefix}-${cmp}-${local.workload_group_suffix}", # For policies
    workload_dynamic_group_name : "${local.data_dynamic_group_name_prefix}-${cmp}-${local.data_dynamic_group_name_suffix}", # For dynamic groups and policies
    description : "${cmp} workload compartment",
    parent_id : var.existing_lz_database_compartment_ocid,
